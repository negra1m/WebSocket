...
var DataService = (function () {
    ...
    DataService.prototype.getQuotes = function () {
        var _this = this;
        this.socket = __WEBPACK_IMPORTED_MODULE_2_socket_io_client__('https://websocketservervnsn.azurewebsites.net:443');
    ...
    DataService.prototype.handleError = function (error) {
        ...
        if (error.error instanceof Error) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].throw(errMessage);
        }
        return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].throw(error || 'Socket.io server error');
    };
